...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayRecordSourceProxy = function () {
	  ...
	  RelayRecordSourceProxy.prototype.commitPayload = function commitPayload(operation, response) {
	    ...
	    if (!response) {
	      return new (__webpack_require__(21))(this, operation.fragment);
	    }

	    var _normalizeRelayPayloa = __webpack_require__(23)(operation.root, response),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayRecordSourceSelectorProxy = function () {
	  ...
	  RelayRecordSourceSelectorProxy.prototype.getResponse = function getResponse() {
	    var snapshot = read(this, this._readSelector, __webpack_require__(51));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayModernEnvironment = function () {
	  ...
	  RelayModernEnvironment.prototype.commitPayload = function commitPayload(operationSelector, payload) {
	    ...
	    var relayPayload = __webpack_require__(23)(operationSelector.root, payload);
	  ...
	  RelayModernEnvironment.prototype.sendQuery = function sendQuery(_ref) {
	    ...
	    this._network.request(operation.node, operation.variables, cacheConfig).then(function (payload) {
	      ...
	      _this2._publishQueue.commitPayload(operation, payload);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RelayPublishQueue = function () {
	  ...
	  RelayPublishQueue.prototype._commitPayloads = function _commitPayloads() {
	    ...
	    this._pendingPayloads.forEach(function (_ref2) {
	      ...
	      var mutator = new (__webpack_require__(19))(_this._store.getSource(), source);
	      var store = new (__webpack_require__(20))(mutator);
	      var selectorStore = new (__webpack_require__(21))(store, operation.fragment);
	      if (fieldPayloads && fieldPayloads.length) {
	        fieldPayloads.forEach(function (fieldPayload) {
	          var handler = _this._handlerProvider && _this._handlerProvider(fieldPayload.handle);
	          __webpack_require__(1)(handler, 'RelayModernEnvironment: Expected a handler to be provided for ' + 'handle `%s`.', fieldPayload.handle);
	  ...
	  RelayPublishQueue.prototype._commitUpdaters = function _commitUpdaters() {
	    ...
	    this._pendingUpdaters.forEach(function (updater) {
	      var mutator = new (__webpack_require__(19))(_this2._store.getSource(), sink);
	      var store = new (__webpack_require__(20))(mutator);
	      updater(store);
	    });
	  ...
	  RelayPublishQueue.prototype._applyUpdates = function _applyUpdates() {
	    ...
	    if (this._pendingOptimisticUpdates.size || this._pendingBackupRebase && this._appliedOptimisticUpdates.size) {
	      ...
	      var store = new (__webpack_require__(20))(mutator, this._handlerProvider);
	...
	function lookupSelector(source, selector) {
	  var selectorData = __webpack_require__(17).read(source, selector, __webpack_require__(2)).data;
	  if (true) {
