...
function find(text, fileName) {
  ...
  !rawModuleName ? process.env.NODE_ENV !== 'production' ? invariant(false, 'FindGraphQLTags: Expected a module name to be defined with ' + '`@providesModule <name>`.') : invariant(false) : void 0;
